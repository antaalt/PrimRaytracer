...
OctNode::OctNode() : OctNode(point3f(0.f), point3f(1.f))
{
}

OctNode::OctNode(const point3f & min, const point3f & max) : BoundingBox(min, max)
{
...
unsigned int OctNode::getOctant(const vec3f & point) const
{
	unsigned int oct = 0;
